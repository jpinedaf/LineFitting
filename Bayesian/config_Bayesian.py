...
#index_cube='08'
#name_id = 'random_cube_{0}'.format(index_cube)
name_id = 'combined_NH3'
# If called from shell with no arguments, innocent_script.py will
# revert to these parameters:
default_yx = (1, 1) # Y, X position in the cube to extract a spectrum from
default_npeaks = 2
...
file_nh311_dr1 = os.path.join(gasdata_dir, 'combined_NH3_11.fits')
file_nh322_dr1 = os.path.join(gasdata_dir, 'combined_NH3_22.fits')
file_rms_nh311_dr1 = os.path.join(gasdata_dir, 'combined_NH3_11_rms.fits')
file_rms_nh322_dr1 = os.path.join(gasdata_dir, 'combined_NH3_22_rms.fits')
file_sig_dr1 = os.path.join(gasdata_dir,  'combined_NH3_11_rms.fits') 
file_esig_dr1 = os.path.join(gasdata_dir, 'combined_NH3_22_rms.fits') 
...
xoff_prior = [-5, 5]
dv_min, dv_max = 0.1, 5.0 # min/max separation of the velocity components
